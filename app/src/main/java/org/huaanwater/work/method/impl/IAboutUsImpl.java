...
public class IAboutUsImpl implements IAboutUs {



    @Override
    public void doGetAboutUs(String url, int size, int index, String tag_code,  final OnDataBackListener onDataBackListener) {
