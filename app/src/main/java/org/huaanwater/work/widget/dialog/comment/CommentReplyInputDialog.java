...
public class CommentReplyInputDialog extends DialogFragment implements
    ...
    public CommentReplyInputDialog() {
    }
...
//        getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_ADJUST_PAN);
        View contentview = View.inflate(getActivity(), R.layout.dialog_input_comment_reply, null);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.tv_publish:
                ...
                if(null != commentInputCallBack) {


                    String content = et_content.getText().toString().trim();

                    commentInputCallBack.onInputSend(content);
                }
